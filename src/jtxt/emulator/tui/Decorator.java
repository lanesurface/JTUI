...
/**
 * Adds dynamic runtime properties to a {@code Component}, thus allowing
 * components to add properties like borders, outlines, and more generic
 * aspects without having to explicitly inherit them from another component.
 * 
 * @see Border
 */
