...
/**
 * Defines a region within the terminal in terms of a start and end location. This
 * class encapsulates these {@code Location}s, as well as providing utilities for
 * constructing, testing, and modifying these regions.
 *
 * @see Location
 */
public class Region {
  ...
  /**
   * Constructs a {@code Region} with the given start and end {@code Location}s.
   *
   * @param start The upper-right {@code Location} for the region.
   * @param end The lower-left {@code Location} for the region.
   *
   * @throws IllegalArgumentException if the start position is greater than the end
   *   position or if the start line is greater than the end line.
   */
  public Region(
    Location start,
    Location end)
  ...
  /**
   * Calculates the width of this region, where the width is the difference between
  ...
  /**
   * Calculates the height of this region, where the height is the difference between
   * the start line and end line.
   *
  ...
  /**
   * Creates a new {@code Region} from the given start position, determining the end
   * {@code Location} from the width and height.
   *
   ...
   *
   * @return A new region which starts at the given location, and which will have the
   *   width and height that are specified.
   */
  public static Region fromLocation(
    Location start,
    int width,
    int height)
  {
