...
public class Location {
  ...
  /**
   * The position within the line that this location represents within the terminal.
   */
  public int position;
  ...
  /**
   * Creates a new location with the same line and position as the given location.
   *
   ...
   *
   * @return True if this location is within the bounds, and false if it lies outside
   *   of it.
   */
  ...
  /**
   * Creates and returns a new {@code Location}, verifying that the indices are valid
   * coordinates for the <code>bounds</code> which have been given.
   *
   * @param bounds The bounds to verify against the coordinates for the new {@code
   *   Location}.
