...
public class Page extends GlyphBuffer {
  ...
  public static class PageSettings {
    ...
    /**
     * Gets the amount of usable space from the top of the page to the bottom of the
     * page.
     *
    ...
    /**
     * Gets the amount of usable space from the left of this page to the right of
     * this page.
     *
  ...
  public Page(
    ...
    Location pageStart = new Location(
      settings.marginTop,
      settings.marginLeft);
    Region bounds = Region.fromLocation(
      pageStart,
      settings.getWidth(),
      settings.getHeight());
