...
public interface DrawableSurface {
  ...
  /**
   * Draws the {@code Region} defined by a start location of (y,&nbsp;x) and end
   * location (height,&nbsp;width) of the given {@code GlyphBuffer}.
   *
  ...
  default void draw(
    ...
    int height)
  {
    draw(buffer.createClippedBuffer(new Region(
      y,
      x,
      height,
      width)));
