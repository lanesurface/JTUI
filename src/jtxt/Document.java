...
public class Document {
     ...
     * settings.
     * 
     * A document must have an associated file on the system, as we cannot
     * display it here. Ultimately, all documents should be persisted on disk.
     * 
     * @param file
     * @param rootLayout
     * @param pageSettings
    ...
    public Document(File file,
        ...
        Arrays.fill(pages, new Page(pageSettings, rootLayout));
    }
