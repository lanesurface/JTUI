...
/**
 * Holds information about the current position to insert text into the 
 * {@code Terminal}.
 */
public class Cursor {
    /**
     ...
     */
    public void setLocation(int newLine, int newPos) {
        location.setLocation(newLine, newPos);
    }
