...
public interface ResizeSubscriber {
    /**
     * This method is called for each subscriber whenever the subject that
     * dictates when these events should be propagated determines that it
     * is necessary to update the dimensions of the interface.
     * 
